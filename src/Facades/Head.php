 ...
 * @method static \Laravel\Head\HeadManager extend(class-string<\Laravel\Head\Metadata\Metadata> $section)
 ...
 * @method static \Laravel\Head\HeadManager robots(string $directives)
 * @method static \Laravel\Head\HeadManager og(\Laravel\Head\OgType|string|null $type = null, ?string $title = null, ?string $description = null, ?string $url = null, ?string $image = null, ?string $video = null, ?string $audio = null, ?string $siteName = null, ?string $locale = null, ?string $determiner = null)
 * @method static \Laravel\Head\HeadManager ogImage(string $url, ?string $alt = null, ?int $width = null, ?int $height = null, ?string $type = null, ?string $secureUrl = null)
 ...
 * @method static \Laravel\Head\HeadManager twitter(\Laravel\Head\TwitterCard|string|null $card = null, ?string $site = null, ?string $creator = null, ?string $title = null, ?string $description = null, ?string $image = null)
 * @method static \Laravel\Head\HeadManager twitterImage(string $url, ?string $alt = null)
 * @method static \Laravel\Head\HeadManager preload(string $href, ?string $as = null, bool|string|null $crossorigin = null, ?string $type = null, ?string $media = null)
 ...
 * @method static \Laravel\Head\HeadManager meta(string $key, string $content, ?bool $property = null)
