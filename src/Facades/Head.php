 ...
 * @method static \Laravel\Head\HeadManager searchableByRobots()
 * @method static \Laravel\Head\HeadManager hiddenFromRobots()
 ...
 * @method static \Laravel\Head\HeadManager preloadAsset(string $path, ?string $as = null, bool|string|null $crossorigin = null, \Laravel\Head\Enums\ImageType|string|null $type = null, \Laravel\Head\Enums\Media|string|null $media = null)
 * @method static \Laravel\Head\HeadManager prefetch(string $href, ?string $as = null)
 * @method static \Laravel\Head\HeadManager prefetchAsset(string $path, ?string $as = null)
